    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?staff/project_task/create/'.$param2, array('class' => 'form-horizontal form-groups-bordered validate project-task-add', 'enctype' => 'multipart/form-data')); ?>

                <div class="form-group">
                    <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('sl.no'); ?></label>

                    <div class="col-sm-7">
                        <input type="number" class="form-control" name="slno" data-validate="required" data-message-required="<?php echo get_phrase('value_required'); ?>" value="" autofocus>
                    </div>
                </div>              
			   <div class="form-group">
